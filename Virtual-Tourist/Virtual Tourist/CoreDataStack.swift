...
class CoreDataStack {
    ...
    // MARK: - Core Data stack - Unaltered from AppDelegate
    
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.roshanravi.Virtual_Tourist" in the application's documents Application Support directory.
